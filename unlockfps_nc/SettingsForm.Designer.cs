namespace unlockfps_nc
{
    partial class SettingsForm
    {
        ...
        private void InitializeComponent()
        {
            ...
            CBStartMinimized.Text = "最小化启动(解锁器)";
            ...
            ComboFullscreenMode.Items.AddRange(new object[] { "无边框", "全屏" });
            ...
            ComboFullscreenMode.Text = "Exclusive";
            //
            // LabelWindowMode
            //
